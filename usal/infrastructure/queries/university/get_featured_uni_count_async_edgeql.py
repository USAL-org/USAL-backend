# AUTOGENERATED FROM 'usal/infrastructure/queries/university/get_featured_uni_count.edgeql' WITH:
#     $ gel-py
...
class GetFeaturedUniCountResult(NoPydanticValidation):
    total_count: int


async def get_featured_uni_count(
